...
let db;
MongoClient.connect('mongodb+srv://admin:dlawlgp927@cluster0.er3sqyt.mongodb.net/?retryWrites=true&w=majority', function(error, client) {
    if (error) return console.log(error);

    db = client.db('todoapp');

    app.listen(7080, function() {
    console.log('listening 7080');
    });
});
